...
docker tag mapreduce/erlangmapreduce:latest public.ecr.aws/v4e3t3o3/mapreduce/erlangmapreduce:latest
docker push public.ecr.aws/v4e3t3o3/mapreduce/erlangmapreduce:latest